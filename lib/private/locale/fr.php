<?php
    if ( defined("LOCALE_MAIN") )
    {
        ...
        $gLocale[ "RaidModeOverbook" ]         = "Par raidlead avec surréservation"; // Please check
    ...
    if ( defined("LOCALE_SETUP") )
    {
        ...
        $gLocale[ "AllowGroupSync" ]           = "Synchroniser les groupes d'utilisateurs externes"; // Please check
        $gLocale[ "AllowPublicMode" ]          = "Enregistrer de nouveaux utilisateurs en tant que membres (non recommandé)"; // Please check
