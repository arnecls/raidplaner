<?php
    ...
    if ( defined("LOCALE_MAIN") )
    {
        ...
        $gLocale[ "UpdateBrowser" ]            = "Zaktualizuj przeglądarkę";
        ...
        $gLocale[ "PleaseRunSetup" ]           = "Uruchom <a href=\"setup\">instalator</a> lub przejdź do <a href=\"http://code.google.com/p/ppx-raidplaner/wiki/ManualSetup\">instrukcji instalacji ręcznej</a>.";

        // General
        $gLocale[ "Reserved" ]                 = "Rezerwacja";
        $gLocale[ "Error" ]                    = "Błąd";
        $gLocale[ "Apply" ]                    = "Zapisz zmiany";
        $gLocale[ "AccessDenied" ]             = "Dostęp wzbroniony";
        ...
        $gLocale[ "WrongPassword" ]            = "Błędne hasło";
    ...
    if ( defined("LOCALE_SETUP") )
    {
        ...
        $gLocale[ "GameconfigProblems" ]       = "Zmiany w pliku lib/config/game.php mogą wywołać niespójność bazy danych (np. postacie z nieprawidłowym przypisaniem ról).";
