...
function displaySettingsAbout( a_Message )
{
	...
	var patchLevel = parseInt((g_SiteVersion - parseInt(g_SiteVersion))*10);
	var patchLevelChar = (patchLevel == 0) ? "" : String.fromCharCode( "a".charCodeAt(0) + patchLevel );
