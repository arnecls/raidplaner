...
function generateSettingsUsers( aXHR )
{
    ...
    HTMLString += "<span class=\"groupSlot box_inlay\">";
    HTMLString += "<div class=\"head\">" + L("Privileged") + "</div>";
    HTMLString += "<div id=\"groupPrivileged\" class=\"content\">";
    HTMLString += "</div>";
    HTMLString += "</span>";

    // Raidlead

    HTMLString += "<span class=\"groupBatch\">";
    ...
    var Privileged = new CGroup("groupPrivileged");
...
function generateSettingsRaid( aXHR )
{
    ...
    Settings["CalendarBigIcons"]= { text : "false", number : 0 };
    ...
    HTMLString += "<div class=\"settingLine\">";
    HTMLString += "<div class=\"settingLabel\">" + L("CalendarBigIcons") + "</div>";
    HTMLString += "<div class=\"settingField\">";
    HTMLString += "<input type=\"checkbox\" id=\"calendarbigicons\""+((Settings["CalendarBigIcons"].text) ? " checked" : "")+"/>";
    HTMLString += "</div></div>";
...
function triggerSettingsUpdate()
{
    ...
    var Privileged = $("#groupPrivileged").data("helper");
    ...
    var PrivilegedArray = Privileged.getUserIdArray();
    ...
    Privileged.updateLinkageArrays(UnlinkedArray, RelinkedArray);
    ...
    var Parameters = {
        ...
        calendarBigIcons: $("#calendarbigicons").prop('checked'),
