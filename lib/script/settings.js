...
function displaySettings( a_XMLData )
{
	...
	HTMLString += "<option value=\"bc\"" + ((settings["Banner"].text == "mop") ? " selected" : "" ) + ">Burning Crusade</option>";
...
function triggerSettingsUpdate()
{
	...
	AsyncQuery( "settings_update", parameters, function() { loadSettings(hash.substr(idIndex+1)); }); 
}
