...
function generateSettingsUsers( aXHR )
{
    ...
    HTMLString += "<span class=\"groupSlot box_inlay\">";
    HTMLString += "<div class=\"head\">" + L("Pugs") + "</div>";
    HTMLString += "<div id=\"groupPug\" class=\"content\">";
    HTMLString += "</div>";
    HTMLString += "</span>";
...
function triggerSettingsUpdate()
{
    ...
    var PugArray      = Pug.getUserIdArray();
    ...
    Pug.updateLinkageArrays(UnlinkedArray, RelinkedArray);
