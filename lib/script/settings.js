...
function generateSettingsLocation( aXHR )
{
    ...
    $.each(aXHR.locationimage, function(index, value) {
        ...
        HTMLString += "<img class=\"clickable\" src=\"images/icons/"+gSite.Iconset+"/raidsmall/" + value + "\" onclick=\"applyLocationImageExternal(this, true)\" style=\"width: 32px; height: 32px; margin-right: 5px;\"/>";
        ++NumImages;
    });
    ...
    $.each(aXHR.location, function(index, value) {
        ...
        HTMLString += "<span class=\"imagepicker locationimg clickable\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/raidsmall/" + LocationImage + ")\"></span>";
...
function generateSettingsRaid( aXHR )
{
    ...
    HTMLString += "<select id=\"timeFormat\" style=\"width: " + ((gSite.TimeFormat == 24) ? 48 : 64) + "px\">";
    ...
    HTMLString += "<select id=\"starthour\" style=\"width: " + ((gSite.TimeFormat == 24) ? 48 : 64) + "px\">";
    ...
    HTMLString += "<select id=\"endhour\" style=\"width: " + ((gSite.TimeFormat == 24) ? 48 : 64) + "px\">";
    ...
    HTMLString += "<select id=\"raidsize\" style=\"width: " + ((gSite.TimeFormat == 24) ? 48 : 64) + "px\">";

    for ( i=0; i<gConfig.GroupSizes.length; ++i)
    {
        HTMLString += "<option value=\""+gConfig.GroupSizes[i]+"\"" + ((Settings["RaidSize"].number == gConfig.GroupSizes[i]) ? " selected" : "" ) + ">"+gConfig.GroupSizes[i]+"</option>";
    }
