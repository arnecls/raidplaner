...
function generateRaidList( aXHR )
{
    ...
    $.each(aXHR.raid, function(index, value) {
        ...
        for ( var i=0; Complete && (i < gConfig.RoleIdents.length); i++ )
        {
        ...
        HTMLString += "<img src=\"images/icons/"+gSite.Iconset+"/raidbig/" + value.image + "\"/>";
        ...
        else
        {
            for ( i=0; i < gConfig.RoleIdents.length; i++ )
            {
                ...
                {
                    HTMLString += "<div class=\"setupInfoSlot\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleImages[i]+")\">";
    ...
    $.each(aXHR.history, function(index, value) {
        ...
        HTMLString += "<img class=\"icon\" src=\"images/icons/"+gSite.Iconset+"/raidsmall/" + value.image + "\"/>";
