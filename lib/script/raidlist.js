...
function generateRaidList( aXMLData )
{
    ...
    $("raids > raid", Message).each( function() {
        ...
        var startDate = $(this).children("startDate:first").text();
        var startTime = $(this).children("start:first").text();
        var endDate   = $(this).children("endDate:first").text();
        var endTime   = $(this).children("end:first").text();
        ...
        HTMLString += formatDateStringUTC(startDate) + "<br/>" + formatTimeStringUTC(startDate,startTime) + " - " + formatTimeStringUTC(endDate,endTime);
        HTMLString += " " + formatDateOffsetUTC(startDate) + "<br/>";
    ...
    $("raidList > raid", Message).each( function(aIndex) {
        ...
        HTMLString += "<div class=\"name\">" + $(this).children("location:first").text() + "<br/><span style=\"font-size: 80%\">" + formatDateStringUTC(startDate) + "</span></div>";
        HTMLString += "</span>";
    });
