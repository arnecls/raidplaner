...
function generateRaidList( aXHR )
{
    ...
    $.each(aXHR.raid, function(index, value) {
        ...
        HTMLString += "<span class=\"locationImg clickable\" id=\"raid" + value.id + "\">";
        ...
        else
        {
            for ( i=0; i < gConfig.RoleIdents.length; i++ )
            {
                ...
                {
                    HTMLString += "<div class=\"setupInfoSlot\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[i]+".png)\">";
