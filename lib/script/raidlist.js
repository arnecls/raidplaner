...
function generateRaidList( aXHR )
{
    ...
    $.each(aXHR.raid, function(index, value) {
        ...
        for ( var i=0; Complete && (i < gConfig.Roles.length); i++ )
        {
        ...
        else
        {
            for ( i=0; i < gConfig.Roles.length; i++ )
            {
                ...
                {
                    HTMLString += "<div class=\"setupInfoSlot\" style=\"background-image: url(lib/layout/images/"+gConfig.Roles[i].style+".png)\">";
