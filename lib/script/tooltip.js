...
function showTooltipClassList( a_ParentElement )
{
    ...
    else
    {
        ...
        $(".class_select").click( function() {
            ...
            var defaultRoleId = g_RoleIds[ defaultRoleIdent ];
            ...
            charList.Characters[charIdx].charClass = classIdent;
            charList.Characters[charIdx].role1 = defaultRoleId;
            charList.Characters[charIdx].role2 = defaultRoleId;
