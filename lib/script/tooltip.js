...
function showTooltipCharChooser( aSlotElement, aPlayer, aMakeSticky, aOnHide )
{
    ...
    if ( !toggleStickyState(aSlotElement.parent(), aMakeSticky)  )
    {
        ...
        HTMLString += "<div class=\""+IconClass+"\" style=\"background-image: url('themes/icons/"+gSite.Iconset+"/classesbig/"+aPlayer.className+".png')\">";
        ...
        HTMLString += "<div class=\"playerTooltipRoleIcon\" style=\"background-image: url('themes/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.firstRole]+".png')\"><div class=\"mainbadge\"></div></div>";
        HTMLString += "<div class=\"playerTooltipRoleIcon\" style=\"background-image: url('themes/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.secondRole]+".png')\"></div>";
        HTMLString += "</div>";
        ...
        if ( aPlayer.characters.length > 1 )
        {
            $(".playerTooltipIconLarge").click( function() {
                ...
                aSlotElement.data("setup_info", CharIdx);
                $(this).css("background-image", "url(themes/icons/"+gSite.Iconset+"/classesbig/"+aPlayer.characters[CharIdx].className+".png)");

                $(this).siblings().children(".playerTooltipRoleIcon:first").css("background-image", "url(themes/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.characters[CharIdx].firstRole]+".png)");
                $(this).siblings().children(".playerTooltipRoleIcon:last").css("background-image", "url(themes/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.characters[CharIdx].secondRole]+".png)");
...
function showTooltipClassList( aParentElement )
{
    ...
    else
    {
        ...
        $(".class_select").click( function() {
            ...
            RoleDiv.children(".newrole1").css("background-image", "url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[Character.role1] + ".png)");
            RoleDiv.children(".newrole2").css("background-image", "url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[Character.role2] + ".png)");
...
function showTooltipClassListMultiSelect( aParentElement )
{
    var Tooltip = $("#tooltip");
    Tooltip.data("sticky", true);
    ...
    else
    {
        ...
        var rebuildSelected = function() {
            var HTMLString = "";
            HTMLString += "<img class=\"shuffle clickable\" src=\"lib/layout/images/move_up.png\"/>";
            ...
            for ( var i=0; i<Character.charClass.length; ++i )
            {
                ...
                HTMLString += "<img class=\"class_selected clickable\" id=\"cs_" + gConfig.Classes[classIdx].ident + "\" src=\"themes/icons/"+gSite.Iconset+"/classessmall/" + gConfig.Classes[classIdx].ident + ".png\"/>";
                ++added;
            }   
...
function showTooltipRoleList( aParentElement, aEditRole1 )
{
    ...
    else
    {
        ...
        for ( var i=0; i<ClassData.roles.length; ++i )
        {
            ...
            HTMLString += "<span class=\"class_select clickable\" id=\"cs_" + RoleIdent + "\"><img src=\"themes/icons/"+gSite.Iconset+"/roles/" + RoleIdent + ".png\"/><br/>" + gConfig.RoleNames[ RoleIdent ] + "</span>";
        }
        ...
        $(".class_select").click( function() {
            ...
            aParentElement.css("background-image", "url(themes/icons/"+gSite.Iconset+"/roles/" + RoleIdent + ".png)" );
