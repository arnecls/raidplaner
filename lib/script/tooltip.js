...
function triggerAttend( selectObj, a_CalendarView )
{
	...
	{
		prompt( L("Please tell us why you will be absent."), L("Set to absent"), L("Cancel"), function() {
...
function showAttendeeTooltip( a_SlotElement, a_Sticky )
{
	if ( g_User == null ) 
		return;
		
	if ( a_SlotElement.children(".comment").length == 0 )
		return;
	...
	container.empty().append( a_SlotElement.children(".comment").clone() );
...
{	
	...
	var classes = Array( "deathknight", "druid", "hunter", "mage", "monk", "paladin", "priest", "rogue", "shaman", "warlock", "warrior" );
	var className = Array( L("Deathknight"), L("Druid"), L("Hunter"), L("Mage"), L("Monk"), L("Paladin"), L("Priest"), L("Rogue"), L("Schaman"), L("Warlock"), L("Warrior") );
...
{	
	...
	classToRole["monk"]        = Array("heal","dmg","tank");
...
function showUserTooltip( a_UserElement, a_Sticky )
{
	...
	HTMLString = L("Move user to group") + "<br/>";
	HTMLString += "<img id=\"userTo0\" class=\"grpicon\" src=\"lib/layout/images/icon_grp0.png\"/>";
	HTMLString += "<img id=\"userTo1\" class=\"grpicon\" src=\"lib/layout/images/icon_grp1.png\"/>";
	HTMLString += "<img id=\"userTo2\" class=\"grpicon\" src=\"lib/layout/images/icon_grp2.png\"/>";
	HTMLString += "<img id=\"userTo3\" class=\"grpicon\" src=\"lib/layout/images/icon_grp3.png\"/>";
