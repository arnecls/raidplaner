...
function showTooltipClassList( aParentElement, aOnChange )
{
    ...
    else
    {
        ...
        $(".class_select").click( function() {
            ...
            var DefaultRoleId = gConfig.RoleIdx[ ClassDesc.defaultRole ];
...
function showTooltipRoleList( aParentElement, aEditRole1 )
{
    ...
    else
    {
        ...
        $(".class_select").click( function() {
            ...
            if ( aEditRole1 )
                CharList.mCharacters[CharIdx].role1 = gConfig.RoleIdx[RoleIdent];
            else
                CharList.mCharacters[CharIdx].role2 = gConfig.RoleIdx[RoleIdent];
