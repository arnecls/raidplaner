...
function showTooltipClassList( aParentElement )
{
    ...
    else
    {
        ...
        for ( var i=1; i<gConfig.Classes.length; ++i )
        {
            ...
            HTMLString += "<span class=\"class_select\" id=\"cs_" + gConfig.Classes[i].ident + "\"><img src=\"themes/icons/"+gSite.Iconset+"/classessmall/" + gConfig.Classes[i].ident + ".png\"/><br/>" + gConfig.Classes[i].text + "</span>";
        }
...
function showTooltipRoleList( aParentElement, aEditRole1 )
{
    ...
    else
    {
        ...
        for ( var i=0; i<ClassData.roles.length; ++i )
        {
            ...
            HTMLString += "<span class=\"class_select\" id=\"cs_" + RoleIdent + "\"><img src=\"themes/icons/"+gSite.Iconset+"/roles/" + RoleIdent + ".png\"/><br/>" + gConfig.RoleNames[ RoleIdent ] + "</span>";
        }
