...
function showTooltipRaidInfo( aParentElement, aCalendarView, aMakeSticky )
{
    ...
    if ( !toggleStickyState(aParentElement, aMakeSticky) )
    {
        ...
        {
            ClassIcons[gUser.characterIds[i]] = "images/icons/"+gSite.Iconset+"/classessmall/" + gUser.characterClass[i] + ".png";
        }
...
function showTooltipRaidComment( aRaidId )
{
    ...
    $(".comment > .text", Container).css( "width", OldWidth - 6 );
...
function applyLocationImage( aImageObj, aUIDataChange )
{
    ...
    $("#locationimagepicker").css( "background-image", "url(images/icons/"+gSite.Iconset+"/raidbig/" + Image + ")" );
...
function applyLocationImageExternal( aImageObj, aUIDataChange )
{
    ...
    Element.css( "background-image", "url(images/icons/"+gSite.Iconset+"/raidsmall/" + Image + ")" );
...
function onLocationChange( aSelectObj )
{
    ...
    else
    {
        ...
        $("#locationimagepicker").css( "background-image", "url(images/icons/"+gSite.Iconset+"/raidbig/"+ ImageName + ")" );
    }
}
...
function showTooltipCharChooser( aSlotElement, aPlayer, aMakeSticky, aOnHide )
{
    ...
    if ( !toggleStickyState(aSlotElement.parent(), aMakeSticky)  )
    {
        ...
        HTMLString += "<div class=\""+IconClass+"\" style=\"background-image: url('images/icons/"+gSite.Iconset+"/classesbig/"+aPlayer.className+".png')\">";
        ...
        HTMLString += "<div class=\"playerTooltipRoleIcon\" style=\"background-image: url('images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.firstRole]+".png')\"><div class=\"mainbadge\"></div></div>";
        HTMLString += "<div class=\"playerTooltipRoleIcon\" style=\"background-image: url('images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.secondRole]+".png')\"></div>";
        HTMLString += "</div>";
        ...
        if ( aPlayer.characters.length > 1 )
        {
            $(".playerTooltipIconLarge").click( function() {
                ...
                aSlotElement.data("setup_info", CharIdx);
                $(this).css("background-image", "url(images/icons/"+gSite.Iconset+"/classesbig/"+aPlayer.characters[CharIdx].className+".png)");

                $(this).siblings().children(".playerTooltipRoleIcon:first").css("background-image", "url(images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.characters[CharIdx].firstRole]+".png)");
                $(this).siblings().children(".playerTooltipRoleIcon:last").css("background-image", "url(images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleIdents[aPlayer.characters[CharIdx].secondRole]+".png)");
...
function showTooltipClassList( aParentElement )
{
    ...
    else
    {
        ...
        for ( var i=1; i<gConfig.Classes.length; ++i )
        {
            ...
            HTMLString += "<span class=\"class_select\" id=\"cs_" + gConfig.Classes[i].ident + "\"><img src=\"images/icons/"+gSite.Iconset+"/classessmall/" + gConfig.Classes[i].ident + ".png\"/><br/>" + gConfig.Classes[i].text + "</span>";
        }
        ...
        $(".class_select").click( function() {
            ...
            aParentElement.css("background", "url(images/icons/"+gSite.Iconset+"/classesbig/" + ClassIdent + ".png)" );
            ...
            RoleDiv.children(".newrole1").css("background-image", "url(images/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[Character.role1] + ".png)");
            RoleDiv.children(".newrole2").css("background-image", "url(images/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[Character.role2] + ".png)");
...
function showTooltipRoleList( aParentElement, aEditRole1 )
{
    ...
    else
    {
        ...
        var ClassString = CharList.mCharacters[CharIdx].charClass[0];
        ...
        for ( var i=0; i<ClassData.roles.length; ++i )
        {
            ...
            HTMLString += "<span class=\"class_select\" id=\"cs_" + RoleIdent + "\"><img src=\"images/icons/"+gSite.Iconset+"/roles/" + RoleIdent + ".png\"/><br/>" + gConfig.RoleNames[ RoleIdent ] + "</span>";
        }
        ...
        $(".class_select").click( function() {
            ...
            aParentElement.css("background-image", "url(images/icons/"+gSite.Iconset+"/roles/" + RoleIdent + ".png)" );
        ...
        ElementOffset.left += aParentElement.width() + 5;
