...
function getDateFromUTCString( a_DateString, a_TimeString )
{
    ...
    return getDateFromUTC( dateSplit[0], dateSplit[1], dateSplit[2], timeSplit[0], timeSplit[1] );
}
...
function formatTimeStringUTC( a_DateString, a_TimeString )
{
    ...
    return formatTime( dateSplit[0], dateSplit[1], dateSplit[2], timeSplit[0], timeSplit[1] );
}
...
function formatDate(a_Year, a_Month, a_Day, a_Hour, a_Minute)
{
    ...
    if ( gTimeFormat == 24 )
    {
        return leadingZero(dateTime.getDate()) + ". " + MonthArray[dateTime.getMonth()-1] + ", " +
    ...
    return MonthArray[dateTime.getMonth()-1] + " " + leadingZero(dateTime.getDate()) + dayPostFix + ", " +
        leadingZero(numericHour) + ":" + leadingZero(dateTime.getMinutes()) + postFix;
}
...
function formatDateStringUTC( a_DateString, a_TimeString )
{
    ...
    return formatDate( dateSplit[0], dateSplit[1], dateSplit[2], timeSplit[0], timeSplit[1] );
}
