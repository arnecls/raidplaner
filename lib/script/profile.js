...
function CCharacterList()
{
    ...
    this.generateSlotFF14 = function( aCurrentChar )
    {
        ...
        if ( aCurrentChar.id === 0 )
        {
            HTMLString += "<div class=\"newname_label\" style=\"top: 35px\">"+L("CharName")+"</div>";
            HTMLString += "<input type=\"text\" class=\"newname\" style=\"top: 35px\" value=\"" + aCurrentChar.name + "\"/>";
        }
        else
        {
            HTMLString += "<div class=\"name\" style=\"top: 35px\">" + aCurrentChar.name + "</div>";
        }
    ...
    this.generateSlots = function( aIndex, aGrpIdx, aMaxSlots )
    {
        ...
        for ( var i=0; (CharIdx < this.mCharacters.length) && (i < aMaxSlots); ++i )
        {
            ...
            else
            {
                ...
                HTMLString += "<div class=\"class_"+gConfig.ClassMode+"\" style=\"background: url(images/icons/"+gSite.Iconset+"/classesbig/" + CurrentChar.charClass[0] + ".png)\">";
