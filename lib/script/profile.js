...
function CCharacterList()
{
    ...
    this.generateSlotWoW = function( aCurrentChar )
    {
        HTMLString = "";        
        HTMLString += "<div class=\"class\" style=\"top: 15px; left: 29px; background: url(themes/icons/"+gSite.Iconset+"/classesbig/" + aCurrentChar.charClass[0] + ".png)\">";
        
        if ( aCurrentChar.mainChar )
            HTMLString += "<div class=\"badge mainchar clickable\" style=\"top: -15px; left: -28px;\"></div>";
        else
            HTMLString += "<div class=\"badge twink clickable\" style=\"top: -15px; left: -28px;\"></div>";

        HTMLString += "</div>";
        
        if ( aCurrentChar.id === 0 )
        {
            HTMLString += "<div class=\"newname_label\" style=\"top: 20px\">"+L("CharName")+"</div>";
            HTMLString += "<input type=\"text\" style=\"top: 20px\" class=\"newname\" value=\"" + aCurrentChar.name + "\"/>";
        }
        else
        {
            HTMLString += "<div class=\"name\" style=\"top: 20px\">" + aCurrentChar.name + "</div>";
        }

        HTMLString += "<div class=\"role_group\" style=\"position: relative; left: 24px; top: 10px\">";

        if ( aCurrentChar.charClass[0] == "empty" )
        {
            HTMLString += "<div class=\"role newrole1 clickable\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/classessmall/empty.png)\"><div class=\"mainrole\"></div></div>";
            HTMLString += "<div class=\"role newrole2 clickable\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/classessmall/empty.png); left: 10px\"></div>";
        }

        else
        {
            HTMLString += "<div class=\"role newrole1 clickable\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role1] + ".png)\"><div class=\"mainrole\"></div></div>";
            HTMLString += "<div class=\"role newrole2 clickable\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role2] + ".png); left: 10px\"></div>";
        }
    ...
    this.generateSlotFF14 = function( aCurrentChar )
    {
        HTMLString = "";        
        HTMLString += "<div class=\"class\" style=\"top: 28px; left: 29px; background: url(themes/icons/"+gSite.Iconset+"/classesbig/" + aCurrentChar.charClass[0] + ".png)\">";
        
        if ( aCurrentChar.mainChar )
            HTMLString += "<div class=\"badge mainchar\" style=\"top: -29px; left: -28px;\"></div>";
        else
            HTMLString += "<div class=\"badge twink\" style=\"top: -29px; left: -28px;\"></div>";

        HTMLString += "</div>";
        
        HTMLString += "<div class=\"job_group\" style=\"position: relative; left: 12px; top: 12px\">";
        HTMLString += "</div>";
                
        if ( aCurrentChar.id === 0 )
        {
            HTMLString += "<div class=\"newname_label\" style=\"top: 40px\">"+L("CharName")+"</div>";
            HTMLString += "<input type=\"text\" class=\"newname\" style=\"top: 40px\" value=\"" + aCurrentChar.name + "\"/>";
        }
        else
        {
            HTMLString += "<div class=\"name\" style=\"top: 40px\">" + aCurrentChar.name + "</div>";
        }
    ...
    this.generateSlots = function( aIndex, aGrpIdx, aMaxSlots )
    {
        ...
        for ( var i=0; (CharIdx < this.mCharacters.length) && (i < aMaxSlots); ++i )
        {
            ...
            if ( (i===0) && (CharIdx !== 0) )
            {
                ...
                HTMLString += "<div class=\"nextgroup clickable box_inlay\" id=\"next" + PrevGroupId + "\">&bull;&bull;&bull;</div>";
            }

            else
            {
                // Game unspecific functions
                ...
                if ( gConfig.ClassMode == "wow" )
                    HTMLString += this.generateSlotWoW( CurrentChar );
                else
                    HTMLString += this.generateSlotFF14( CurrentChar );
        ...
        else
        {
            ...
            HTMLString += "<div class=\"nextgroup clickable box_inlay\" id=\"next" + NextGroupId + "\">&bull;&bull;&bull;</div>";
        }
...

    {
        ...
        Groups.each( function() {
            ...
            $(this).children(".charslot").each( function() {
                ...
                if ( IsNew || gConfig.ClassMode == "ff14")
                {
                    $(this).children(".class")
                        .addClass("clickable")
