...
function CCharacterList()
{
    ...
    {
        HTMLString = "";        
        HTMLString += "<div class=\"class\" style=\"top: 15px; left: 29px; background: url(images/icons/"+gSite.Iconset+"/classesbig/" + aCurrentChar.charClass[0] + ".png)\">";
        ...
        {
            HTMLString += "<div class=\"role newrole1\" style=\"background-image:url(images/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role1] + ".png)\"><div class=\"mainrole\"></div></div>";
            HTMLString += "<div class=\"role newrole2\" style=\"background-image:url(images/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role2] + ".png); left: 10px\"></div>";
        }
    ...
    {
        HTMLString = "";        
        HTMLString += "<div class=\"class\" style=\"top: 28px; left: 29px; background: url(images/icons/"+gSite.Iconset+"/classesbig/" + aCurrentChar.charClass[0] + ".png)\">";
    ...
    this.generateSlots = function( aIndex, aGrpIdx, aMaxSlots )
    {
        ...
        for ( var i=0; (CharIdx < this.mCharacters.length) && (i < aMaxSlots); ++i )
        {
            ...
            if ( (i===0) && (CharIdx !== 0) )
            {
                ...
                HTMLString += "<span class=\"nextgroup box_inlay\" id=\"next" + PrevGroupId + "\">&#183&#183&#183</span>";
            }
            ...
            else
            {
                ...
                HTMLString += "<span class=\"charslot box_inlay\" id=\"char" + CharIdx + "\">";
        ...
        {
            // New char button
            HTMLString += "<span class=\"newchar box_inlay\">+</span>";
        }
        ...
        else
        {
            ...
            HTMLString += "<span class=\"nextgroup box_inlay\" id=\"next" + NextGroupId + "\">&#183&#183&#183</span>";
        }
