...
function CCharacterList()
{
    ...
    this.DisplaySlots = function( a_Index, a_MaxSlots )
    {
        var HTMLString = "";
        var charIdx = a_Index;
        ...
        for ( var i=0; (charIdx < this.Characters.length) && (i < a_MaxSlots); ++i )
        {
            ...
            if ( (i==0) && (charIdx != 0) )
            {
                ...
                var prevGroupId = (a_Index / a_MaxSlots) - 1;                
        ...
        {        
            // next group slot
            var nextGroupId = (a_Index / a_MaxSlots) + 1;                
    ...
    {
        var slotsPerGroup = 6;
        var groupCount = Math.ceil( this.Characters.length / slotsPerGroup );
        var HTMLString = "";
        ...
        for ( var grpIdx=0; grpIdx<groupCount; ++grpIdx )
        {
            HTMLString += "<div id=\"grp"+grpIdx+"\" class=\"charGroup\">";
            HTMLString += this.DisplaySlots( grpIdx*slotsPerGroup, slotsPerGroup );
            HTMLString += "</div>";
        }
