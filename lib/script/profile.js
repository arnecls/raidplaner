...
function generateUserAttendance( aXHR )
{
    ...
    if (NumRoleAttends === 0)
    {
       HTMLString += "<span class=\"bar gradient_missed\" style=\"width: " + BarSize + "px\"><div class=\"count\">&nbsp;</div></span>";
    }
    else
    {
        ...
        {
           if ( RoleAttends[i] > 0 )
               HTMLString += "<span class=\"bar_part gradient_"+gConfig.RoleImages[i]+"\" style=\"width: " + RoleBarSizes[i].toFixed() + "px\">" + RoleAttends[i] + "</span>";
        }
    }
    ...
    {
       HTMLString += "<span>";
       HTMLString += "<div class=\"box gradient_"+gConfig.RoleImages[i]+"\"></div>";
