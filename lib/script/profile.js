...
function CCharacterList()
{
    ...
    this.generateSlotWoW = function( aCurrentChar )
    {
        ...
        {
            HTMLString += "<div class=\"role newrole1\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/classessmall/empty.png)\"><div class=\"mainrole\"></div></div>";
            HTMLString += "<div class=\"role newrole2\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/classessmall/empty.png); left: 10px\"></div>";
        }

        else
        {
            HTMLString += "<div class=\"role newrole1\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role1] + ".png)\"><div class=\"mainrole\"></div></div>";
            HTMLString += "<div class=\"role newrole2\" style=\"background-image:url(themes/icons/"+gSite.Iconset+"/roles/" + gConfig.RoleIdents[aCurrentChar.role2] + ".png); left: 10px\"></div>";
        }
    ...
    this.generateSlots = function( aIndex, aGrpIdx, aMaxSlots )
    {
        ...
        for ( var i=0; (CharIdx < this.mCharacters.length) && (i < aMaxSlots); ++i )
        {
            ...
            if ( (i===0) && (CharIdx !== 0) )
            {
                ...
                HTMLString += "<div class=\"nextgroup box_inlay\" id=\"next" + PrevGroupId + "\">&bull;&bull;&bull;</div>";
            }
        ...
        {
            // New char button
            HTMLString += "<div class=\"newchar box_inlay\">+</div>";
        }
        ...
        else
        {
            ...
            HTMLString += "<div class=\"nextgroup box_inlay\" id=\"next" + NextGroupId + "\">&bull;&bull;&bull;</div>";
        }
