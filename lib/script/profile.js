...
function generateCharacterSlot( a_Id, a_Name, a_Mainchar, a_Class, a_Role1, a_Role2 )
{
	...
	HTMLString += "<span><img class=\"role role1\" style=\"margin-left:24px\" src=\"images/classessmall/" + g_RoleIdents[a_Role1] + ".png\"/></span>";
	HTMLString += "<span><img class=\"role role2\" src=\"images/classessmall/" + g_RoleIdents[a_Role2] + ".png\"/></span>";
...
function generateNewCharacterSlot()
{
	...
	HTMLString += "<span><img class=\"role newrole1\" style=\"margin-left:24px\" src=\"images/classessmall/" + defaultRole + ".png\"/></span>";
	HTMLString += "<span><img class=\"role newrole2\" src=\"images/classessmall/" + defaultRole + ".png\"/></span>";
...
function setupAttendance( a_Message )
{
	...
	for ( var i=0; i<g_RoleIdents.length; ++i )
    {	
	   HTMLString += "<div><div class=\"box role"+(i+1)+"\"><span class=\"start\"></span><span class=\"end\"></span></div>";
