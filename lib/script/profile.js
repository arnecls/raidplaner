...
function generateProfileSettings(aXHR)
{
    ...
    HTMLString += "<div class=\"settingfield\">";
    HTMLString += "<textarea id=\"vacationMessage\">"+((aXHR.settings.VacationMessage == undefined) ? "" : aXHR.settings.VacationMessage.TextValue)+"</textarea>";
    HTMLString += "</div></div>";
    ...
    if (aXHR.settings.VacationStart != undefined)
        $("#vacation_start").datepicker("setDate", new Date(aXHR.settings.VacationStart.IntValue * 1000));
    
    if (aXHR.settings.VacationEnd != undefined)
        $("#vacation_end").datepicker("setDate", new Date(aXHR.settings.VacationEnd.IntValue * 1000));
}
