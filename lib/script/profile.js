                ...
                var onChangeClass = function() {
                    ...
                    {        
                        ...
                        if ( gConfig.ClassMode == "multi" )
                        {
                            ...
                            HTMLString += "<div class=\"single\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[roleIdx]+"_rnd.png)\"></div>";
                        }
                        else if ( roleCount == 1 )
                        {
...
function generateUserAttendance( aXHR )
{
    ...
    else
    {
        ...
        {
           if ( RoleAttends[i] > 0 )
               HTMLString += "<span class=\""+gConfig.RoleImages[i]+"\" style=\"width: " + RoleBarSizes[i].toFixed() + "px\"><div class=\"count\">" + RoleAttends[i] + "</div></span>";
        }
    }
    ...
    {
       HTMLString += "<span>";
       HTMLString += "<div class=\"box "+gConfig.RoleImages[i]+"\"></div>";
...
function generateProfileSettings(aXHR)
{
    ...
    HTMLString += "<div class=\"settingLine\" style=\"margin-top:5px\"><div class=\""+passLabelClass+"\">"+L("Password")+"</div>";
    ...
    HTMLString += "<div class=\"settingLine\" style=\"margin-top:2px\"><div class=\""+passLabelClass+"\">"+L("RepeatPassword")+"</div>";
    HTMLString += "<div class=\"settingField\"><input type=\"password\" id=\"pass_repeat\" disabled=\"disabled\"/></div></div>";

    // Vacation

    HTMLString += "<div class=\"settingLine settingNewSection\" style=\"margin-top:15px\"><div class=\"settingLabel\">"+L("VacationStart")+"</div>";
