...
function CCharacterList()
{
    ...
    this.generateSlotWoW = function( aCurrentChar )
    {
        ...
        if ( aCurrentChar.id === 0 )
        {
            ...
            HTMLString += "<input type=\"text\" style=\"top: 24px\" class=\"newname\" value=\"" + aCurrentChar.name + "\"/>";
        }
        else
        {
            HTMLString += "<div class=\"name\" style=\"top: 24px\">" + aCurrentChar.name + "</div>";
        }
            ...
            $(this).children(".charslot").each( function() {
                ...
                var onChangeClass = function() {
                    ...
                    {        
                        ...
                        if ( roleCount == 1 )
                        {
                            HTMLString += "<div class=\"single\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[CurrentChar.role1]+"_rnd.png)\"></div>";
                        }        
                        else
                        {
                            HTMLString += "<div class=\"primary clickable\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[CurrentChar.role1]+"_rnd.png)\"></div>";
                            HTMLString += "<div class=\"secondary clickable\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[CurrentChar.role2]+"_rnd.png)\"></div>";
                        }
                    }
                    ...
                    $(".primary", CharSlot).click( function( aEvent ) {
                        ...
                        var roleIdx = (roles.indexOf(gConfig.RoleIdents[CurrentChar.role1]) + 1) % roles.length;
                        CurrentChar.role1 = gConfig.RoleIdx[roles[roleIdx]];
                        
                        $(this).animate({left: -60}, 100, function() {
                            $(this).css("background-image","url(lib/layout/images/"+gConfig.RoleImages[CurrentChar.role1]+"_rnd.png)");
                    ...
                    $(".secondary", CharSlot).click( function( aEvent ) {
                        ...
                        var roleIdx = (roles.indexOf(gConfig.RoleIdents[CurrentChar.role2]) + 1) % roles.length;
                        CurrentChar.role2 = gConfig.RoleIdx[roles[roleIdx]];
                        
                        $(this).animate({right: -60}, 100, function() {
                            $(this).css("background-image","url(lib/layout/images/"+gConfig.RoleImages[CurrentChar.role2]+"_rnd.png)");
                ...
                if ( IsNew || (gConfig.ClassMode == "ff14"))
                {
                    ...
                    classIcon.click( function( aEvent ) {
                        if (gConfig.ClassMode == "ff14")
                            showTooltipClassListMultiSelect( $(this) );
                        else
