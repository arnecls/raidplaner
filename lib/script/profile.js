...
function generateProfileSettings(aXHR)
{
    ...
    HTMLString += "<div><div class=\"settinglabel\">"+((gUser.isAdmin && (gUser.id != aXHR.userid)) ? L("AdminPassword") : L("OldPassword"))+"</div>";
    HTMLString += "<div class=\"settingfield\"><input type=\"password\" id=\"pass_old\"/></div></div>";
    
    HTMLString += "<div style=\"margin-top:5px\"><div class=\"settinglabel\">"+L("Password")+"</div>";
    HTMLString += "<div class=\"settingfield\"><input type=\"password\" id=\"pass_new\" disabled=\"disabled\"/></div></div>";
    
    HTMLString += "<div><div class=\"settinglabel\"></div><div class=\"settingfield\">";
    HTMLString += "<div id=\"profile_strprogress\"><span class=\"pglabel\">"+L("PassStrength")+"</span><span id=\"strength\"></span></div>";
    HTMLString += "</div></div>";
        
    HTMLString += "<div><div class=\"settinglabel\">"+L("RepeatPassword")+"</div>";
    HTMLString += "<div class=\"settingfield\"><input type=\"password\" id=\"pass_repeat\" disabled=\"disabled\"/></div></div>";
    
    // Vacation
    
    HTMLString += "<div style=\"margin-top:10px\"><div class=\"settinglabel\">"+L("VacationStart")+"</div>";
    HTMLString += "<div class=\"settingfield\">";
    HTMLString += "<span class=\"datepicker_icon\"></span><input type=\"text\" class=\"datepicker\" id=\"vacation_start\"/>";
    HTMLString += "</div></div>";
    
    HTMLString += "<div><div class=\"settinglabel\">"+L("VacationEnd")+"</div>";
    HTMLString += "<div class=\"settingfield\">";
    HTMLString += "<span class=\"datepicker_icon\"></span><input type=\"text\" class=\"datepicker\" id=\"vacation_end\"/>";
    HTMLString += "</div></div>";
