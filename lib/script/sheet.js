...
function showSheetNewRaid( aXHR, aDay, aMonth, aYear )
{
    ...
    HTMLString += "<span style=\"float: left; width: 230px\">";
    ...
    $.each( aXHR.locationimage, function(index, value) {
        ...
        HTMLString += "<img class=\"clickable\" src=\"images/icons/"+gSite.Iconset+"/raidsmall/" + value + "\" onclick=\"applyLocationImage(this, false)\" style=\"width: 32px; height: 32px; margin-right: 5px;\"/>";
        ++numImages;
    });
