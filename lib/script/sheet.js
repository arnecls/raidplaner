...
function showSheetNewRaid( a_XMLData, a_Day, a_Month, a_Year )
{
	...
	$("#locationimagepicker")
		...
		.click( function() { showTooltipRaidImageList(); event.stopPropagation(); } );
    ...
    Message.children("settings").children().each( function() {
    	defaultSettings[$(this)[0].tagName] = parseInt( $(this).text() );
    });
    ...
    $("#eventblocker").css("visibility", "visible").click( startFadeTooltip );
