...
function onLocationChange( aSelectObj )
{
    ...
    if ( aSelectObj.selectedIndex === 0)
    {
        ...
        $("#locationimagepicker").click( function(aEvent) { showTooltipRaidImageList(); aEvent.stopPropagation(); } );
...
function showSheetNewRaid( aXMLData, aDay, aMonth, aYear )
{
    ...
    LocationImages.each( function(index) {
        ...
        HTMLString += "<img src=\"images/raidsmall/" + $(this).text() + "\" onclick=\"applyLocationImage(this, false)\" style=\"width: 32px; height: 32px; margin-right: 5px;\"/>";
        ++numImages;
    });
