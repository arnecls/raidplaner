...
function generateCalendar(aXHR)
{
    ...
    var TimeIter    = new Date( StartYear, StartMonth, StartDay, 0, 0, 0 );
    ...
    for (var WeekIdx=0; WeekIdx<6; ++WeekIdx)
    {
        ...
        for (var ColIdx=0; ColIdx<7; ++ColIdx)
        {
            ...
            var DateIsInThePast = (TimeIter.getFullYear() < Today.getFullYear()) || ((TimeIter.getMonth() <= Today.getMonth()) && (TimeIter.getDate() < Today.getDate()));
            var FieldClass = "day";
