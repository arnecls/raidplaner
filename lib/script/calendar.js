...
function generateRaidTooltip( a_RaidDataXML, a_DateIsInThePast, a_CalendarView )
{
    var HTMLString = "";
...
function generateCalendar( a_XMLData )
{
    startFadeTooltip();
    closeSheet();
    ...
    $(".raid")
        ...
        .dblclick( function( event ) { changeContext( "raid,setup," + parseInt( $(this).attr("id").substr(4), 10 ) ); event.stopPropagation(); } );
