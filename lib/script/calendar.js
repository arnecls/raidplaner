...
function generateRaidTooltip( aRaid, aDateIsInThePast, aCalendarView )
{
    ...
    var RoleIdx     = parseInt(aRaid.role, 10);
    ...
    {
        StatusText = L("RaidingAs") + " " + L(gConfig.RoleNames[gConfig.RoleIdents[RoleIdx]]);
        StatusClass += "ok";
        RoleIcon = gConfig.RoleImages[RoleIdx];
    }
    ...
    HTMLString += "<div class=\"icon clickable\" style=\"background: url('themes/icons/"+gSite.Iconset+"/raidbig/" + RaidImg + "')\"></div>";
