    ...
    if ( !aDateIsInThePast && HasCharacters )
    {
            ...
            (CharacterIdx >= 0) )
        {
            ...
            else
            {
                ...
                if (Role1Id != Role2Id)
                {
                    HTMLString += "<select class=\"attend_sub\">";// style=\"width: 48px\">";
    ...
    for (var WeekIdx=0; WeekIdx<6; ++WeekIdx)
    {
        ...
        for (var ColIdx=0; ColIdx<7; ++ColIdx)
        {
                    ...
                    matchesDate(aXHR.raid[RaidIdx], TimeIter))
            {
                ...
                {
                    StatusClass += "ok";
                    StatusOk =  '<span class="ui-icon ui-icon-check"></span>'
                }
                ...
                HTMLString += "<div class=\"status "+ StatusClass + RoleClass + " shadow_inlay\">" +
                    (CalendarBigIcons ? "<span class=\"role_info\"></span>" : "") +
                    StatusOk + "<span class=\"raidsize\">" + RaidSize + "</span>" + "</div>";
