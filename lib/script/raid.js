...
function CRaidMemberList()
{
    ...
    this.generatePlayerSlot = function( aPlayer, aClipStatus )
    {
        ...
        HTMLString += "<div class=\"playerIcon\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)\">";
    ...
    this.generateEmptySlot = function( aClipStatus )
    {
        ...
        HTMLString += "<div class=\"emptySlot "+LayoutClass+"\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/roles/"+gConfig.RoleImages[aClipStatus.roleId]+")\">";
        HTMLString += "</div>";
    ...
    this.generateAddRandomSlot = function( aClipStatus, aOverEmptySlot )
    {
        ...
        if (aOverEmptySlot)
        {
            ...
            HTMLString += "<div class=\"randomSlot clickable "+LayoutClass+"\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/roles/"+RoleRndImage+")\">";
            HTMLString += "</div>";
        }
        else
        {
    ...
    this.generateAbsentSlot = function( aPlayer, aClipStatus )
    {
        ...
        HTMLString += "<div class=\"playerIcon\" id=\"ap_icon"+aPlayer.id+"\" style=\"background-image: url(images/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)\">";
        HTMLString += "</div>";
        HTMLString += "<div class=\"playerName\">" + aPlayer.name + "</div>";
    ...
    this.bindClipPlayer = function( aClipItem )
    {
        ...
        aClipItem.children(".editableName").each( function() {
            ...
            $(this).blur( function() {
                ...
                $(this).prev()
                    .css("background-image", "url(images/icons/"+gSite.Iconset+"/classessmall/random.png)")
                    .unbind("click");
            });
        });
    ...
    this.bindClips = function( aParent )
    {
        ...
        if ( gUser.isRaidlead )
        {
            ...
            Clips.children(".waitSlot, .waitSlotComment").each( function() {
                ...
                var Image     = "images/icons/"+gSite.Iconset+"/classessmall/" + Player.className + ".png";
                var Slot      = $(this);
...
function generateRaidInfo( aXHR, aAppendTo )
{
    ...
    HTMLString += "<img src=\"images/icons/"+gSite.Iconset+"/raidbig/" + RaidImage + "\" class=\"raidicon\">";
...
function onClickAbsentSlot(aEvent, aElement, aPlayer, aUndecided)
{
    ...
    else
    {
        var onAbortFunction = function() {
            ...
            aElement.css("background-image", "url(images/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)");
...
function generateRaidSettings( aXHR )
{
    ...
    $.each(aXHR.locationimage, function(index, value) {
        ...
        HTMLString += "<img class=\"clickable\" src=\"images/icons/"+gSite.Iconset+"/raidsmall/" + value + "\" onclick=\"applyLocationImage(this, true)\" style=\"width:32px; height:32px; margin-right:5px;\"/>";
        ++NumImages;
    });

    $("#locationimagelist").append(HTMLString);
    $("#locationimagepicker").css("background-image", "url(images/icons/"+gSite.Iconset+"/raidbig/"+RaidImage+")");
