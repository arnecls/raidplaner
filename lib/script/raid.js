	...
	this.displayAsBench = function() 
	{
		...
		for ( i=0; i<this.players.length; ++i )
		{
			...
			if ( g_User.isRaidlead || (this.players[i].comment.length != 0) )
			{
				...
				{
					HTMLString += "<span class=\"comment_item\">";
					HTMLString += "<img id=\"to_" + this.players[i].role1 + "_" + this.name + "_" + i + "\" onclick=\"addToSlotFromComment(this)\" class=\"comment_role\" src=\"images/classessmall/" + this.players[i].role1 + ".png\"/>";
					HTMLString += "<div class=\"move_up\"></div>";
					
					if ( (this.players[i].id != 0) && (this.players[i].role1 != this.players[i].role2) )
					{
						HTMLString += "<img id=\"to_" + this.players[i].role2 + "_" + this.name + "_" + i + "\" onclick=\"addToSlotFromComment(this)\" class=\"comment_role\" src=\"images/classessmall/" + this.players[i].role2 + ".png\"/>";
