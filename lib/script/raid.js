...
function CRaidMemberList()
{
    ...
    this.generateEmptySlot = function( aClipStatus )
    {
        ...
        HTMLString += "<div class=\"emptySlot "+LayoutClass+"\" style=\"background-image: url(lib/layout/images/"+gConfig.RoleImages[aClipStatus.roleId]+")\">";
        HTMLString += "</div>";
    ...
    this.generateAddRandomSlot = function( aClipStatus, aOverEmptySlot )
    {
        ...
        if (aOverEmptySlot)
        {
            ...
            HTMLString += "<div class=\"randomSlot clickable "+LayoutClass+"\" style=\"background-image: url(lib/layout/images/"+RoleRndImage+")\">";
            HTMLString += "</div>";
        }
        else
        {
