            ...
            $(this).focus( function() {
                $(this).prev()
                    ...
                    .click( function(aEvent) {
                        ...
                        updateSlackersBadges(PlayerList);
                    });
            });
...
function generateRaidInfo( aXHR, aAppendTo )
{
    ...
    HTMLString += "<div class=\"raidsize\">" + Attended + " / " + RaidSize + " " + L("Players") + "</div>";
...
function updateSlackersBadges(aPlayerList)
{
    ...
    aPlayerList.forEachPlayer( function(player) {
        ...
        if ((player.status == "ok") || (player.status == "available")) ++attendedCount;
    });
    ...
    if (attendedCount > 0)
        $("#attenders_badge").append("<span style=\"color: #0f0\">" + attendedCount + "</span>");
}
