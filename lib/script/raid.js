...
function displayRaidSettings( a_MessageXML, a_RaidXML )
{
    ...
    var panel = $("#raidsettings").children(".settingspanel:first");
    ...
    var raidStartHour   = parseInt(raidStart.substr(0,raidStart.indexOf(":")));
    var raidStartMinute = parseInt(raidStart.substr(raidStart.indexOf(":")+1));
    
    var raidEnd       = a_RaidXML.children("end:first").text();
    var raidEndHour   = parseInt(raidEnd.substr(0,raidEnd.indexOf(":")));
    var raidEndMinute = parseInt(raidEnd.substr(raidEnd.indexOf(":")+1));
    ...
    HTMLString += "<div class=\"settingField\"><select id=\"raidstatus\">";
    ...
    HTMLString += "<div class=\"settingField\"><select id=\"raidsetupstyle\">";
    ...
    raidSlots.each( function(index) {
        if ( index < g_RoleIdents.length )
        {
            HTMLString += "<div class=\"settingLabel\">"+L("RequiredForRole")+" \""+g_RoleNames[g_RoleIdents[index]]+"\"</div>";
            HTMLString += "<div class=\"settingField\"><input type=\"text\" class=\"settingEdit\" style=\"width:24px;\" value=\""+$(this).text()+"\"/></div>";
        }
    });
...
function loadRaidPanel( a_Name, a_RaidId )
{
    ...
    else
    {
        ...
        case "settings":
            showRaidPanel("#raidsettings", "settings");
            break;
        }
    }
}