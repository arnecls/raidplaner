...
function CRaidMemberList()
{
    ...
    this.generatePlayerSlot = function( aPlayer, aClipStatus )
    {
        ...
        HTMLString += "<div class=\"playerIcon\" style=\"background-image: url(themes/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)\">";
    ...
    this.generateAbsentSlot = function( aPlayer, aClipStatus )
    {
        ...
        HTMLString += "<div class=\"playerIcon\" id=\"ap_icon"+aPlayer.id+"\" style=\"background-image: url(themes/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)\">";
        HTMLString += "</div>";
        HTMLString += "<div class=\"playerName\">" + aPlayer.name + "</div>";
    ...
    this.bindClips = function( aParent )
    {
        ...
        if ( gUser.isRaidlead )
        {
            ...
            Clips.children(".waitSlot, .waitSlotComment").each( function() {
                ...
                var Image     = "themes/icons/"+gSite.Iconset+"/classessmall/" + Player.className + ".png";
                var Slot      = $(this);
...
function onClickAbsentSlot(aEvent, aElement, aPlayer, aUndecided)
{
    ...
    else
    {
        var onAbortFunction = function() {
            ...
            aElement.css("background-image", "url(themes/icons/"+gSite.Iconset+"/classessmall/"+aPlayer.className+".png)");
