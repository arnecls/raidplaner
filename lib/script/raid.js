...
function CRaidMemberList()
{
    ...
    this.addRandomPlayer = function( aRoleId )
    {
        ...
        var NewPlayer = {
            ...
            classIdent  : function() { return "random"; },
    ...
    {
        return gGame.Classes[aPlayer.classIdent()].style;
    }
...
function triggerRaidUpdate()
{
    ...
    PlayerList.getModifiedPlayersForRole(aRole, Role1players);
