...
function CSlot( a_Name, a_Slots )
{
	...
	this.displayAsSlot = function() 
	{
		...
		if ( g_User.isRaidlead )
		{
			...
			slotField.children(".slotrow").children(".occupied")
				.dblclick( function() { addToBench( $(this) ); });
		}
...
function displayRaid( a_XMLData )
{
	...
	if ( g_User.isRaidlead )
	{
		...
		$("#locationimagepicker").mouseout( delayedFadeTooltip );		
	...
	HTMLString += "<div id=\"tankbenchtoggle\" class=\"tankbench tankbenchactive\"><div class=\"onBench\" id=\"count_tank\"></div></div>";
