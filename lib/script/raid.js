...
function CRaidMemberList()
{
    ...
    this.generateRoleList = function( aRoleId, aColumns, aRequiredSlots )
    {
        ...
        var RoleIdent = gConfig.RoleIdents[aRoleId];
        var HTMLString = "";
        ...
        if (gConfig.RoleIdx[RoleIdent] == gConfig.RoleIdents.length-1)        
            HTMLString += "<div class=\"roleList\" style=\"margin-right:0\">";
        else
            HTMLString += "<div class=\"roleList\">";
        
        HTMLString += "<h3>"+L(gConfig.RoleNames[RoleIdent])+" <span class=\"attendance_count\">"+AttendedForRole+"/"+aRequiredSlots+"</span></h3>";
...
function generateRaidSettings( aXHR )
{
    ...
    $.each(aXHR.slots, function(index, value) {
        ...
        {
            HTMLString += "<div class=\""+((index == 0) ? "settingLine settingNewSection" : "settingLine")+"\"><div class=\"settingLabel\">"+L("RequiredForRole")+" \""+gConfig.RoleNames[gConfig.RoleIdents[index]]+"\"</div>";
