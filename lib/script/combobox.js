(function( $ ) {
    $.widget( "ui.combobox", {
        ...
        _create: function() {
            ...
            var height = Math.max(18, selectNode.outerHeight());
            ...
            $("#" + nodeId + "_open, #"+nodeId+"_value").click( function( event ) {
                ...
                var startIdx = selectNode.context.selectedIndex;
        ...
        editable: function( a_Enable ) {
			...
			if ( a_Enable )
            {
                ...
                $("#"+this.elementId+"_edit").val( this.element.context.options[ this.element.context.selectedIndex ].text ).focus()
                    .click(function(event) { event.stopPropagation(); });
            }
            else
            {
                HTMLString = "<span class=\"combobox_valuetext\">" + this.element.context.options[ this.element.context.selectedIndex ].text + "</span>";
                $("#"+this.elementId+"_value").empty().append(HTMLString);
            }
        },
