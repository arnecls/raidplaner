(function( $ ) {
	$.widget( "ui.combobox", {
		...
		_create: function() {
			...
			var selected = selectNode.children( ":selected" );
			...
			HTMLString += "<button class=\"combobox_value\" id=\"" + valueId + "\">" + selected.text() + "</button><button class=\"combobox_open\" id=\"" + openId + "\"></button>";
            ...
            $("#"+editId).parent().css( "margin-right", "2px" );
