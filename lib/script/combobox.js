    ...
    $.widget( "ui.combobox", {
        ...
        _create: function() {
            ...
            this.optionField.children(".option").click( function() {
                ...
                var ValueField = $("#"+NodeId+"_value:first").empty();
                
                if ( Icons[$(this).val()] != undefined )
                {
                    ValueField.append("<img src=\"" + Icons[$(this).val()] + "\"/><div class=\"combobox_valuetext\">" + $(this).text() + "</div>");
                }
                else
                {
                    ValueField.append("<div class=\"combobox_valuetext\">" + $(this).text() + "</div>");
                }
